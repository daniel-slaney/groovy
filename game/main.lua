...
function love.gamepadaxis( joystick, axis, value )
	-- this is too noisey
	-- print("love.gamepadaxis", joystick:getID(), axis, value)

	if machine then
		machine:gamepadaxis(joystick, axis, value)
	end
end

function love.gamepadpressed( joystick, button )
	print("love.gamepadpressed", joystick:getID(), button)

	if machine then
		machine:gamepadpressed(joystick, button)
	end
end

function love.gamepadreleased( joystick, button )
	print("love.gamepadreleased", joystick:getID(), button)

	if machine then
		machine:gamepadreleased(joystick, button)
	end
end
